...
declare const UpdateSignalingChannelCommand_base: {
    new (input: UpdateSignalingChannelCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateSignalingChannelCommandInput, UpdateSignalingChannelCommandOutput, KinesisVideoClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: UpdateSignalingChannelCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateSignalingChannelCommandInput, UpdateSignalingChannelCommandOutput, KinesisVideoClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;

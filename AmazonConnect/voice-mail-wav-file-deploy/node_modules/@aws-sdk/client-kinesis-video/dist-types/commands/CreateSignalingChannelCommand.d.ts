...
declare const CreateSignalingChannelCommand_base: {
    new (input: CreateSignalingChannelCommandInput): import("@smithy/smithy-client").CommandImpl<CreateSignalingChannelCommandInput, CreateSignalingChannelCommandOutput, KinesisVideoClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: CreateSignalingChannelCommandInput): import("@smithy/smithy-client").CommandImpl<CreateSignalingChannelCommandInput, CreateSignalingChannelCommandOutput, KinesisVideoClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;

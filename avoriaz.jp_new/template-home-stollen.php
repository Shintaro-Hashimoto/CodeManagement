...
<style>
    /* (ご提示のPHP内CSSをそのまま維持) */
    .custom-home-wrapper { font-family: "Helvetica Neue", Arial, sans-serif; color: #333; }
    .hero-section { position: relative; height: 80vh; min-height: 500px; display: flex; align-items: center; justify-content: center; text-align: center; color: #fff; overflow: hidden; background-color: #333; }
    .hero-slider, .hero-slide { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }
    .hero-slide { background-size: cover; background-position: center; opacity: 0; transition: opacity 2.5s ease-in-out; z-index: 1; }
    .hero-slide.active { opacity: 1; z-index: 2; }
    .hero-overlay { background: rgba(0, 0, 0, 0.3); position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 3; }
    .hero-content { position: relative; z-index: 4; padding: 20px; }
    .hero-title { font-size: 3rem; margin-bottom: 20px; font-weight: bold; text-shadow: 0 2px 10px rgba(0,0,0,0.5); }
    .hero-subtitle { font-size: 1.2rem; margin-bottom: 40px; line-height: 1.6; }
    
    /* (シュトーレンCSSは残っていても問題ありません) */
    .promo-section { max-width: 1000px; margin: -60px auto 60px; position: relative; z-index: 5; padding: 0 20px; }
    .promo-box { background-color: #fff; border: 2px solid #8D6E63; border-radius: 12px; padding: 30px; box-shadow: 0 15px 40px rgba(0,0,0,0.15); background-image: linear-gradient(to bottom right, #fff, #fffbf5); overflow: hidden; }
    ...
    .service-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 30px; max-width: 1200px; margin: 0 auto 80px; padding: 0 20px; position: relative; z-index: 3; }
    .service-card { background: #fff; text-align: center; border-radius: 8px; box-shadow: 0 10px 30px rgba(0,0,0,0.08); transition: transform 0.3s ease; display: flex; flex-direction: column; overflow: hidden; height: 100%; }
    ...
    .btn-custom { display: inline-block; padding: 10px 30px; background-color: #E76F51; color: #fff; text-decoration: none; border-radius: 50px; font-weight: bold; transition: background 0.3s; align-self: center; }
    ...
    .insta-section { max-width: 1200px; margin: 0 auto 60px; padding: 0 20px; text-align: center; }
...
<div class="custom-home-wrapper">
    ...
    <section class="hero-section">
        <div class="hero-slider">
            <div class="hero-slide active" style="background-image: url('/wp-content/themes/my-inventory-theme/images/hero1.jpg');"></div>
            <div class="hero-slide" style="background-image: url('/wp-content/themes/my-inventory-theme/images/hero2.jpg');"></div>
            <div class="hero-slide" style="background-image: url('/wp-content/themes/my-inventory-theme/images/hero3.jpg');"></div>
            <div class="hero-slide" style="background-image: url('/wp-content/themes/my-inventory-theme/images/hero4.jpg');"></div>
        </div>
